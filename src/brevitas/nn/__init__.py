...
from .quant_avg_pool import QuantAvgPool2d, QuantAdaptiveAvgPool2d, QuantAvgPool3d, QuantAdaptiveAvgPool3d
...
from .quant_conv import QuantConv1d, QuantConv2d, QuantConv3d
